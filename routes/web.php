...
Route::get('about', 'App\Http\Controllers\TodosController@about');
Route::get('new', 'App\Http\Controllers\TodosController@new');
Route::get('contact', 'App\Http\Controllers\TodosController@contact');
